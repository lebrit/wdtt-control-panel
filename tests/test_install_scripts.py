...
class InstallScriptTests(unittest.TestCase):
    def test_version_is_consistent(self):
        ...
        self.assertIn('PANEL_VERSION="0.11.24"', installer)
        self.assertIn('__version__ = "0.11.24"', package)
        self.assertIn("Текущая версия: 0.11.24", readme)
    ...
    def test_installer_has_update_and_certificate_renewal(self):
        ...
        self.assertIn('WDTT_REF="${WDTT_REF:-v1.3.5}"', script)
        ...
        self.assertIn('"spaceneurox_v1_3_5"', script)
