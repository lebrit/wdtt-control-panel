...
class InstallScriptTests(unittest.TestCase):
    def test_version_is_consistent(self):
        ...
        self.assertIn('PANEL_VERSION="0.10.1"', installer)
        self.assertIn('__version__ = "0.10.1"', package)
        self.assertIn("Текущая версия: 0.10.1", readme)
    ...
    def test_installer_has_update_and_certificate_renewal(self):
        ...
        self.assertIn("TimeoutStartSec=15min", script)
    ...
    def test_user_labels_and_bulk_actions_are_exposed(self):
        ...
        self.assertIn("<th>Метка</th>", html)
