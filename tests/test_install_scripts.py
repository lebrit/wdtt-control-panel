...
class InstallScriptTests(unittest.TestCase):
    def test_version_is_consistent(self):
        ...
        self.assertIn('PANEL_VERSION="0.11.18"', installer)
        self.assertIn('__version__ = "0.11.18"', package)
        self.assertIn("Текущая версия: 0.11.18", readme)
    ...
    def test_user_labels_and_bulk_actions_are_exposed(self):
        ...
        self.assertIn('id="openwrt-dialog"', html)
        self.assertIn('id="copy-openwrt-command"', html)
        self.assertIn('id="copy-openwrt-vless"', html)
        ...
        self.assertIn('openOpenWrtDialog', script)
        self.assertIn('api("openwrt/podkop-plus"', script)
