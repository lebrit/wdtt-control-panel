...
Агент вызывает фиксированный локальный список операций: создать, изменить, удалить или прочитать WDTT-пользователя и получить снимок узла. Агент не открывает входящий административный порт.
